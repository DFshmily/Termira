  ...
  "zh-CN": {
    ...
    tools: {
      ...
      monitor: {
        ...
        noSession: "连接终端后可采集监控。",
        empty: "等待监控数据",
        unavailableReason: "监控数据暂不可用。",
        memory: "内存",
        disk: "磁盘",
        network: "网络",
        load: "负载",
        updatedAt: "更新时间",
        cpuDetail: "通过 /proc/stat 采集",
        uptime: "运行时间",
        refresh: "采集",
        refreshing: "3 秒刷新中",
      ...
      processes: {
        unavailable: "进程管理已在阶段 6 通过 SSH exec 接入真实列表。",
        title: "进程列表",
        loading: "正在读取进程",
        empty: "暂无进程数据",
        noSession: "连接终端后可读取进程。",
        searchPlaceholder: "搜索 PID、用户或命令",
        command: "命令",
        kill: "结束进程",
        sortBy: (label: string) => `按${label}排序`,
        confirmKill: (pid: number, name: string) => `结束进程 ${pid}（${name}）？`,
      ...
      commands: {
        ...
        content: "命令内容",
        note: "备注",
        profileScoped: "绑定当前主机",
        globalScoped: "全局",
        hostScoped: "当前主机",
        nameRequired: "请输入命令名称。",
        commandRequired: "请输入命令内容。",
        confirmDelete: (name: string) => `删除快捷命令「${name}」？`,
        send: "发送"
      }
    },
    settings: {
  ...
  "en-US": {
    ...
    tools: {
      ...
      monitor: {
        ...
        noSession: "Connect a terminal to collect metrics.",
        empty: "Waiting for metrics",
        unavailableReason: "Monitor metrics are unavailable.",
        memory: "Memory",
        disk: "Disk",
        network: "Network",
        load: "Load",
        updatedAt: "Updated",
        cpuDetail: "Collected from /proc/stat",
        uptime: "Uptime",
        refresh: "Collect",
      ...
      processes: {
        unavailable: "Process management is wired through SSH exec in stage 6.",
        title: "Process list",
        loading: "Loading processes",
        empty: "No process data",
        noSession: "Connect a terminal to read processes.",
        searchPlaceholder: "Search PID, user, or command",
        command: "Command",
        kill: "Kill process",
        sortBy: (label: string) => `Sort by ${label}`,
        confirmKill: (pid: number, name: string) => `Kill process ${pid} (${name})?`,
      ...
      commands: {
        ...
        loading: "Loading quick commands",
        ...
        content: "Command",
        note: "Note",
        profileScoped: "Bind to current host",
        globalScoped: "Global",
        hostScoped: "Current host",
        nameRequired: "Enter a command name.",
        commandRequired: "Enter command content.",
        confirmDelete: (name: string) => `Delete quick command "${name}"?`,
        send: "Send"
      }
    },
    settings: {
