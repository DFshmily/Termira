  ...
  "zh-CN": {
    ...
    tools: {
      ...
      files: {
        ...
        renameNameRequired: "请输入不包含 / 的新名称。",
        loading: "正在读取远程目录",
        empty: "目录为空",
      ...
      forwards: {
        ...
        loading: "正在读取转发规则",
        empty: "暂无端口转发规则",
        noProfile: "选择主机后可配置端口转发。",
        noSession: "连接该主机后可启动端口转发。",
        name: "名称",
        type: "类型",
        bindHost: "监听地址",
        bindPort: "监听端口",
        ...
        edit: "编辑",
        delete: "删除",
        dynamicTarget: "SOCKS 动态目标",
        boundTo: (name: string) => `绑定主机：${name}`,
        confirmDelete: (name: string) => `删除转发规则「${name}」？`,
        nameRequired: "请输入规则名称。",
        portInvalid: "请输入 1-65535 的监听端口。",
        targetRequired: "请输入目标地址和 1-65535 的目标端口。",
        typeLabels: {
          local: "本地",
          remote: "远程",
          dynamic: "动态"
  ...
  "en-US": {
    ...
    tools: {
      ...
      files: {
        ...
        renameNameRequired: "Enter a new name without /.",
      ...
      forwards: {
        ...
        formTitle: "New forwarding rule",
        editTitle: "Edit forwarding rule",
        newRule: "New rule",
        saveRule: "Save rule",
        updateRule: "Update rule",
        cancelEdit: "Cancel",
        loading: "Loading forwarding rules",
        empty: "No forwarding rules",
        noProfile: "Select a host to configure port forwarding.",
        noSession: "Connect this host to start port forwarding.",
        name: "Name",
        type: "Type",
        bindHost: "Bind host",
        bindPort: "Bind port",
        ...
        edit: "Edit",
        delete: "Delete",
        dynamicTarget: "SOCKS dynamic target",
        boundTo: (name: string) => `Host: ${name}`,
        confirmDelete: (name: string) => `Delete forwarding rule "${name}"?`,
        nameRequired: "Enter a rule name.",
        portInvalid: "Enter a bind port from 1-65535.",
        targetRequired: "Enter a target host and target port from 1-65535.",
        typeLabels: {
          local: "Local",
          remote: "Remote",
          dynamic: "Dynamic"
